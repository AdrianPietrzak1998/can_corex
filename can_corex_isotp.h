...
/**
 * @brief Internal function - set ISO-TP TX instance for FC parser
 *
 * Must be called before using CCX_ISOTP_TX_FC_Parser.
 * Typically called internally by CCX_ISOTP_TX_Init.
 *
 * @param Instance Pointer to TX instance
 */
...
/**
 * @brief Internal function - set ISO-TP RX instance for parser
 *
 * Must be called before using CCX_ISOTP_RX_Parser.
 * Typically called internally by CCX_ISOTP_RX_Init.
 *
 * @param Instance Pointer to RX instance
 */
